...
export default function Cart() {
  const { cartItems, removeFromCart, getTotal , getTotalForSpan} = useContext(ShopContext);
  const total = getTotalForSpan() ;
  return (
    ...
    :
    <>
    <p className="text-black-50 fs-4 text-center">Your Cart It's Empty.</p>
    </>}
    </div>
  );
}
